...
<head>
    ...
    <link rel="stylesheet" href="css/verify_email.css">  <!-- Подключаем внешний CSS -->
        ...
        if (isset($_GET['token'])) {
            ...
            if($result->num_rows == 1){
                ...
                if($user["is_email_verified"] == 0){
                    ...
                    echo '<div class="success-message">Почта уже подтверждена! Вы можете <a href="adm/login.php">войти</a>.</div>';
                }
            } else{
